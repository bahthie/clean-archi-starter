...
export default class MentoringSlotController {
  constructor(
    ...
    private readonly getMentoringSlotByMissedService: GetMentoringSlotByMissedService
  ) {}

  @Get("/was-missed")
  async getMissedMentoringSlots(): Promise<MentoringSlot[]> {
    return await this.getMentoringSlotByMissedService.getMentoringSlotByMissed();
  }
